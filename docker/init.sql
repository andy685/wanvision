...
-- ----------------------------------------------------------------------------
INSERT INTO `style_presets` (`name`, `value`, `prompt`, `description`, `sort_order`, `is_active`, `created_at`, `updated_at`) SELECT '3D 漫剧', '3d', 'stylized 3D animated drama style, high-quality game-engine render, clearly fictional non-photorealistic characters, animated film character design, soft sculpted facial features, expressive but simplified eyes, clean skin without photo-real pores, painterly PBR materials, cinematic animation lighting, no real person, no photorealistic portrait, no live-action photo look', '风格化 3D 动画短剧质感，弱化真人照片感，适合作为视频参考素材', 1, 1, '2026-08-08T15:10:25.385Z', '2026-08-08T15:10:25.386Z' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM `style_presets` WHERE `value` = '3d');
